...
class F {
  ...
  */
  ...
  toggleStatus(e) {
    ...
    e === F.status.FAILED && (this.nodes.mediaContainer.innerHTML = `<div class="ck-media-error"><b>Error loading Asset</b> <br> <span class="url">${this.nodes.mediaEl.src} </span></div>`);
  }
  /**
